...
<WifiQRCode ssid={'NetworkNotFound'} password={'cjtetonscout16'} />
...
Some things that happen around the house:

- Dining room light turns off at 11pm 
- Front door locks (if its not already locked) at 11pm
- Sprinklers turn on around 4am most mornings
